...
public sealed class InstagramWebClient : PlatformWebClient
{
    ...
    public Task<HttpResponseMessage> GetInstagramPostAsync(
    ...
    )
    {
        ...
        var data = new Dictionary<string, string>
        {
            ...
            {
                "variables",
                $"{{\"shortcode\":\"{identifier.Id}\",\"fetch_tagged_user_count\":null,\"hoisted_comment_id\":null,\"hoisted_reply_id\":null}}"
            }
        };
    ...
    public Task<HttpResponseMessage> GetInstagramResponseAsync(
        string url,
        CancellationToken cancellationToken
    )
    {
