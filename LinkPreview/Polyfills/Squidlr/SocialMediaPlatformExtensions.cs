...
{
    public static HttpClient GetPlatformHttpClient(
    ...
    )
    {
        return platform switch
        {
            SocialMediaPlatform.Twitter
                => httpClientFactory.CreateClient(Twitter.TwitterWebClient.HttpClientName),
            SocialMediaPlatform.Instagram
                => httpClientFactory.CreateClient(Instagram.InstagramWebClient.HttpClientName),
