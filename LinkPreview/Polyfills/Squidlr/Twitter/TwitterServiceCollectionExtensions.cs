...
using LinkPreview.Polyfills.Squidlr.Twitter.Services;
...
public static class TwitterServiceCollectionExtensions
{
    public static IServiceCollection AddTwitter(this IServiceCollection services)
    {
        services
            .AddHttpClient(
                TwitterWebClient.HttpClientName,
                (sp, client) =>
                {
                    ...
                    client.DefaultRequestHeaders.Add(
                        "authorization",
                        $"Bearer {options.TwitterAuthorizationBearerToken!}"
                    );
                ...
                (services, request) =>
                    HttpPolicyExtensions
                        ...
                        .WaitAndRetryAsync(
                            ...
                            {
                                services
                                    .GetService<ILogger<TwitterWebClient>>()
                                    ?.LogWarning(
